...
// 'v32' the map is coloured by compliance status, not cultivation category:
// light green passed, light red non-compliant, light blue exempt. Same axis
// the filter chips use, so filtering to Non-compliant leaves exactly the red
// plots on screen. The legend now lists only the colours actually present.
const VERSION = 'v32';
